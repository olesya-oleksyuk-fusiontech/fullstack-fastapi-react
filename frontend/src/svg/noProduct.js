    ...
    <svg xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 0 500 500">
      ...
      <g clipRule="evenodd">
        <path
          ...
          strokeMiterlimit="10"
        />
        <g fillRule="evenodd" fill={strokeColor}>
          <path
            d="M196.6 225.7c0 10.9-8.9 19.8-19.8 19.8s-19.8-8.8-19.8-19.8c0-10.9 8.9-19.8 19.8-19.8s19.8 8.9 19.8 19.8zM315.2 225.7c0 10.9-8.9 19.8-19.8 19.8s-19.8-8.8-19.8-19.8c0-10.9 8.8-19.8 19.8-19.8 10.9 0 19.8 8.9 19.8 19.8z"
          />
        </g>
      </g>
      <path
